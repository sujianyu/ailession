...
# 可用于预测，因为是线性增加，我这里采取用instant列代替。根据程序exploreBikeshare.py中特征相关性可以去掉atemp,season
X_train = _2011data.drop(['cnt', 'dteday', 'yr', 'casual', 'registered','atemp','season'], axis=1)
